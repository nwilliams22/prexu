# Historical native-player rollout

Archived during the 2026-09-20 documentation audit. The content below records
the original Windows rollout, including obsolete paths, branches, commands and
architecture. It is evidence, not current setup or resume guidance. See
[the current implementation status](../native-player-status.md).
