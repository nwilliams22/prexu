...
Original July 2026 proposal, archived 2026-09-20. Its gap statements and task
lists describe the pre-implementation baseline. The `prexu-pd1x` epic is now
closed. See [current coverage](../test-automation-plan.md).
